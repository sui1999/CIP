...
parser.add_argument('--encoder', type=str,
                    default='MERIT', help='Name of encoder: PVT or MERIT')
parser.add_argument('--skip_aggregation', type=str,
                    default='concatenation', help='Type of skip-aggregation: additive or concatenation')
...
if __name__ == "__main__":
    ...
    args.exp = 'PVT_GCASCADE_MUTATION_w3_7_Run1_' + dataset_name + str(
        args.img_size)  # + '_cc_th' +str(args.cc_th) #HR_CASCADERun3_
    ...
    if args.encoder == 'PVT':
        net = PVT_GCASCADE(n_class=args.num_classes, img_size=args.img_size, k=11, padding=5, conv='mr', gcb_act='gelu',
                           skip_aggregation=args.skip_aggregation)
    elif args.encoder == 'MERIT':
        net = MERIT_GCASCADE(n_class=args.num_classes, img_size_s1=(args.img_size, args.img_size),
                             img_size_s2=(224, 224), k=11, padding=5, conv='mr', gcb_act='gelu',
                             skip_aggregation=args.skip_aggregation)
    else:
